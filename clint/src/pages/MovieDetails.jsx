...
const MovieDetails = () => {
  ...
  const {shows, axios, user, fetchFavoriteMovies, getToken, favoriteMovies, image_base_url} = useAppContext()
    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <h1 className="text-xl font-semibold max-w-96 text-balance">
            {show.movie.title}
          </h1>
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <button className="bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95" onClick={handleFavourite}>
        ...
        <button onClick={()=>{navigate("/movies"); scrollTo(0,0)}} className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-lg font-medium cursor-pointer">Show More</button>
      </div>
    </div>
  ) : (
    <Loading/>
